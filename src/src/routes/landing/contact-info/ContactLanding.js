...
const position = [10.762622, 106.690103];
    ...
    >
      ...
      <div className="contact__info">
        ...
        <section>
          ...
          <ul>
            <li>- Email: support@sushitime.com</li>
            <li>- Phone: (+84) 123 456789</li>
            <li>- Hours: Monday - Friday, 8:00am - 9:00pm</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            <li>- Email: info@sushitime.com</li>
          </ul>
        </section>
        <section>
          ...
          <ul>
            <li>- Email: feedback@sushitime.com</li>
          </ul>
        </section>
      </div>
    </motion.article>
