    ...
    <article className="about__collaboration">
      ...
      <section className="about__collaboration__content">
        ...
        <p>
          ...
          sushi and salads to sandwiches and pasta dishes, so you can be sure
          there's something for everyone to enjoy. Don't forget, Sushi Time is a
          fictional sushi restaurant made by Ekaterine Mitagvaria.
        </p>
        <Link
          to="/contact"
